...
Plugin URI: https://www.isaumya.com/portfolio-item/if-modified-since-header-for-wordpress/
...
= 1.2.4, 1.2.5 =
* Major bug fix - showing improper date and time. Special thanks to Martin for sharing a test environment to debug and fix this old issue.
